...
function edigital_admin_scripts( $hook ) {
    ...
    wp_enqueue_script( 'edigital-admin-script', get_template_directory_uri() .'/assets/js/admin-scripts.js', array( 'jquery' ), '1.0.0', true );

    wp_enqueue_style( 'edigital-admin-style', get_template_directory_uri() . '/assets/css/admin-style.css', '1.0.0' );
}
...
function edigital_scripts() {
	...
	wp_enqueue_style( 'edigital-style', get_stylesheet_uri() );
    ...
    if( $header_sticky_option != 'hide' ) {
        ...
        wp_enqueue_script( 'edigital-sticky-setting', get_template_directory_uri() .'/assets/library/sticky/sticky-setting.js', array( 'jquery-sticky' ), '1.0.0', true );
    }
    
    wp_enqueue_script( 'edigital-custom-script', get_template_directory_uri() . '/assets/js/custom-script.js', array( 'jquery' ), '1.0.0', true );
