        ...
        ?>
            <p>
                ...
                <select name="<?php echo esc_attr( $instance->get_field_name( $edigital_widgets_name ) ); ?>" id="<?php echo esc_attr( $instance->get_field_id( $edigital_widgets_name ) ); ?>" class="widefat">
                    <?php foreach ( $edigital_widgets_field_options as $athm_option_name => $athm_option_title ) { ?>
        ...
        case 'upload':
            ...
            <label for="<?php echo esc_attr( $instance->get_field_id( $edigital_widgets_name ) ); ?>"><?php echo esc_html( $edigital_widgets_title ); ?>:</label><br />
                ...
                <div class="actions clearfix">
                    <button type="button" class="button edigital-delete-button align-left"><?php _e( 'Remove', 'edigital' ); ?></button>
                    <button type="button" class="button edigital-upload-button alignright"><?php _e( 'Select Image', 'edigital' ); ?></button>
...
function edigital_widgets_updated_field_value( $widget_field, $new_field_value ) {
    ...
    if ( $edigital_widgets_field_type == 'number') {
        ...
        if ( !isset( $edigital_widgets_allowed_tags ) ) {
            // If not, fallback to default tags
            $edigital_widgets_allowed_tags = '<p><strong><em><a><iframe><span>';
        }
        return strip_tags( $new_field_value, $edigital_widgets_allowed_tags );
