	...
	<?php if (count($categoriesTree) > 1 OR count($channels) > 0): ?>
		<form class="cmvl-navbar-navigation">
			<?php if (count($categoriesTree) > 1): ?>
				<label class="cmvl-navbar-categories"><span><?php echo esc_html(ucfirst(Labels::getLocalized('course'))); ?>:</span><select name="category">
			...
			<?php if (count($channels) > 0): ?>
				<label class="cmvl-navbar-channels"><span><?php echo esc_html(ucfirst(Labels::getLocalized('lesson'))); ?>:</span><select name="channel">
