...
<p class="form-finalize">
	<a href="<?php echo esc_attr($resetLabelsUrl); ?>" class="right button cmvl-confirm-click">Reset Text Labels</a>
	<a href="<?php echo esc_attr($clearCacheUrl); ?>" class="right button cmvl-confirm-click">Clear cache</a>
