...
use com\cminds\videolesson\addon\eddpay\helper\DateTimeHelper;

use com\cminds\videolesson\addon\eddpay\model\User;

abstract class DummyPageController extends Controller {
	
	const QUERY_DUMMY_PAGE = 'cmeddpay_dummy_page';
	const DUMMY_POST_TYPE = 'page';
	const DUMMY_POST_ID = -1447522;
