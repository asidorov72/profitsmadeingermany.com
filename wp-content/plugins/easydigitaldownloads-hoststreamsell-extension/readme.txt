...
Added support to pick JW Player 6 or 7

= 2.01 =

Fixed bug which can sometimes cause access option id not to be sent in REST API call when purchase is made. Also changed product images to use big thumbnails so they should be higher quality

= 2.02 =

Further fix to option_id bug first fixed in 2.01

= 2.03 =

Fix compatibility issue with fitVids javascript

= 2.04 =

Further fitVids workaround

= 2.1 =

Moved to using EDD_Payment class
